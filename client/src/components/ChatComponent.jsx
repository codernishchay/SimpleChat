function ChatComponent(){
    return(
      ...
      <div
        ...
        class="top:0px; overscroll-behavior: none;"
      >
        ...
        <div class="my-3 text-green-100 font-bold text-lg tracking-wide">@rallipi</div>      <svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 24 24"
    ...
    <div class="fixed w-full flex justify-between bg-green-100" class="bottom: 0px;">
      <textarea
        ...
        class="outline: none;"
      ></textarea>
      <button class="m-2" class="outline: none;">
        <svg
